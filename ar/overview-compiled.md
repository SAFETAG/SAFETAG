...
![SAFETAG أنشطة](images/activities_flow.svg)
...
![SAFETAG تدفق بيانات](images/info_flows/data_flow_all.svg)

بينما سيتم تعريف المكونات بالتفصيل فى أجزاء "تحليل الخطر" و"بناء الوكالة"، هذا موجز لمكونات مسار البيانات:

* **الجهات الممثلة Actors** الجهات الممثلة أو الممثلون هم الأشخاص ذوي الصلة بالمنظمة، من موظفين، وأعضاء مجلس الإدارة، وشكراء، ومتعاقدين مع المنظمة. يمكن أن يشمل الممثلون أيضاً المتطوعين، وأعضاء مجتمع العمل بشكل أوسع، وحتى أفراد العائلة. وقد يتضمّن الممثلون أيضاً خصوم المنظمة مثل المجموعات المنافسة لها.
* ** الأنشطة Activities** الأنشطة هى فعاليات وعمليات المنظمة. بينما تتمحور معظم أعمال المنظمات غير الحكومية حول مفاهيم المهمات المحددة، قد تتضمّن الأنشطة أشياء مثل سجل الرّواتب.
* **القدرة Capacity** مؤشرات القدرة تشمل مهارات الموظفين ومختلف أنواع المصادر التي ترتكز المنظمة عليها لإحداث التغيير.
* **العوائق Barriers** العوائق هى تحديات معينة تواجهها المنظمة والتي يمكن أن تمنع أو تحد من قدراتها.
* **الأصول Assets** يمكن اختزال الأصول  في أنظمة الحاسوب - أي الكمبيوترات المحمولة، والخوادم، ولكنها قد تشمل أيضاً البيانات المخرنة فيها، أو خدمات مثل تخزين الملفات عن بعد، والمواقع المستضافة، والبريد الالكتروني، وغير ذلك. ويمكن أيضاً إدراج الأقراص التخزين، و أجهزة USB، وحتى الأوراق المطبوعة التي تحتوي على معلومات حساسة تحت هذا البند.
* **الثغرات Vulnerabilities** الثغرات هي عيوب معينة أوصفات لأحد الأصول التي تجعل منها عرضةً للهجوم.
* **التهديدات Threats** التهديد هو هجوم معين ومحتمل، أو حدث يمكن أن يلحق ضرراً بالمنظمة. اذا كانت سلة من قطع قماش مبللة بمادة مشتعلة هي ثغرة، فالحريق هو التهديد - والحد من التهديد يكمن في قواعد ضد ترك قطع القماش مبللة بمادة مشتعلة في الأنحاء، وفي وجود طفّايات الحريق، وكاشفات عن الدخان، ونسخ احتياطية للسياسات عن بعد، وخطط للإخلاء.
...
 يختلف SAFETAGعن كثير من أدوات تحليل الخطر لأنه يهدف إلى بناء قدرة المنظمة المضيفة والعاملين فيها ليكونوا قادرين على مواجهة المخاطر التى حددها المدقق. صمّم SAFETAG ليقدم أنشطة وتدريب ضمن عملية التقييم تعنى بزيادة قدرة المنظمة بالوكالة على تحرّي ومواجهة التحديات الأمنية في داخل المنظمة. ليتمكن من ذلك، يجب على المدقق أن يجمع معلومات تسمح بالتعرّف على مساحات الضعف والقوة لدى المنظمة (الخبرة، التمويل، الرغبة فى التعلم، وقت العاملين، ... الخ).
...
* *دليل*: [الأمن في صندوق: التخزين الآمن للملفات](https://securityinabox.org/en/guide/secure-file-storage/)
...
* ** إنشاء جهة اتصال عند الطوارئ: ** إنشاء إجراء للتعامل مع الحوادث وجهة اتصال في حالات الطوارئ عند تسبب المدقق في أو كشفه عن حادثة أثناء دورة التقييم؟                                                                                  [^NIST_SP_800-115-Section_7.1]^,^[^PETS_emergency_contact]
* ** إجراء البحوث ** ((See [Context Research](#context-research)       لتحديد الخصوم المحتملين وقدراتهم، واستكشاف آخر الاتجاهات في الأمن الرقمي والمواضيع المتعلقة، لتقييم مخاطر عملية التدقيق ذاتها.
* ** الاستعداد للسفر: ** تحقق من احتياجات السفر اللوجستية - التأشيرة ، خطاب الدعوة ، تذاكر السفر وحجوزات الفنادق. لاحظ أن بعض التأشيرات يمكن أن تأخذ مجهودًا هاماً وقد تتطلب أن يكون المدقق بدون جواز سفر أثناء معالجتها.
* ** تحضير الأنظمة: ** قم بتحديث واختبار الأنظمة الخاصة بك ، A / V وأدوات التدقيق [^ أخر_نسخة_من_الأدوات] ، وقم بتحضير أجهزة التخزين والأنظمة لتعكس الأمان التشغيلي المطلوب ، وتأكد من أن لديك محولات طاقة وكابلات ومحولات ملائمة ، محركات الأقراص USB  ، وبطاقات لاسلكية خارجية وأي معدات أخرى مطلوبة للاختبار.
...
هذا المكون يسمح للمدقق لتحديد السياق المتعلق بالمنطقة و التكنولوجيا اللازم لتقديم تدقيق آمن و مطّلع. هذا المكون يتكون من بحث مكتبى يتم تجميعه و تحليله عن طريق المدقق و أيضا المدخلات من مكون المقابلة.
...
منهجية التقييم بعيدة المدى تركز على المراقبة المباشرة للمؤسسة و بنيتها التحتية، يشمل ذلك استطلاعات مصادر البيانات المتوفرة بشكل علني ("إستخبارات المصدر المفتوح") مما يسمح للمدقق بتحديد المصادر المتاحة (مثل: المواقع الإلكترونية، الشبكات الخارجية، خوادم البريد الإلكتروني، و أيضا بيانات مواقع التواصل الإجتماعي) الموصولة بالمؤسسة و التي يمكن جمع بيانات عنها عن بعد..

### غرض


بينما أكثر تركيز SAFETAG على تحديات الأمن الرقمي داخل وحول المكتب ، فإن المعلومات غير المقصودة المتاحة من "المصادر المفتوحة" يمكن أن تشكل تهديدات حقيقية وتستحق اهتماما أكبر. هذا أيضا يبني فهم المدقق للحضور الرقمي للمنظمة ويرشده لنقاط ضعف محددة للتحقيق فيه مرة أخرى في الموقع.
...
هذه العملية تكشف أيضاً عن الاستخدامات الخارجية للخدمة (مثل خدمات جوجل، أو دروب بكس، أو غيرها) والتي تعمل بدورها -سواء بنية أو لا -- كظل للبنية التحتية للمنظمة. يمكن تحديد العديد من الأجهزة التابعة لمستخدمين عند اتباع هذه العملية بالأضافة إلى تمرين *Monitor Open Wireless Traffic*.
...
* ماهو شكل الشبكة ؟ وماهي أجهزة المودم والروتر (الموجهات) ؟
إدارتها ؟
* ماهي الخدمات (على سبيل المثال: الدربوكس (تقنية تخزين سحابي) ،الويب ميل ، الخ ) التي تعمل على الشبكة والتي لم تذكر من قِبل العاملين في المنظمة؟
...
* ** مراقبة الحركة في الشبكة اللاسلكية المفتوحة: ** مراقبة الحركة في اللاسلكي للتسليم ، المرشدات اللاسلكية ، والعناوين الفيزيائية .
...
الأجهزة المخترقة بإمكانها إضعاف قدرة أي مؤسسة على تأمين بياناتها. من الضروري معرفة ما إذا كانت الأجهزة تحصل على برامج و تحديثات الأمان الأساسية. و معرفة سبل الحماية الأساسية المتوفرة ضد أي دخول غير مصرح به تساعد على تصميم إستراتيجية لجعل الحواسيب أكثر أمانا. و لأن هيكل SAFETAG يركز على أمان البيانات. من الضروري أيضا عدم غض النظر عن الأجهزة نفسها التي تخزن البيانات بما في ذلك الشبكات السلكية.
...
* ماهي الممارسات الأمنية الرسمية وغير الرسمية التي يستخدمها المشاركين في تحديد المخاطر؟
...
* هل هناك إجراءات تخفيف إذا فقدت الأجهزة أو تم أخذها من قبل الخصوم؟ (على سبيل المثال: محركات الأقراص المشفرة والنسخ الاحتياطي خارج الموقع؟)
...
* **قم بإجراء فحص يدوي للأجهزة"** تفحص و سجل المعلومات المتعلقة بمستخدمي الأجهزة (سواء ذات علاقة بالعمل أو شخصية) بهدف الأمان (وجود كلمات مرور، مستويات التحديثات، مزايا المستخدمين، تشفير محركات التخزين، المنافذ أو الخدمات الجارية، قدرات مضاد الفيروسات).
...
* **يوم من أيام الحياة:** أطلب من الموظفين إعلامك "بيوم معتاد في حياتهم" لترى نوعية الأجهزة التي يستخدمونها، كيف يستخدمونها، و ما نوع البيانات التي عليهم التعامل معها لأداء عملهم.

### المخرجات

* قائمة بأصول المنظمة ومن ينتمون إليها
...
* قائمة بالخوادم الغير آمنة و وحدات التشغيل و الأقراص الخارجية و أي موارد إلكترونية غير آمنة.
* ملاحظات حول تدابير الأمان المتبعة عادة لكل الأنظمة الإلكترونية.
* كلمات السر المكتوبة.


### الأمن التشغيلي

  * تعامل مع المعلومات المجمعة / المدروسة بقمة السرية والحساسية. أي ملاحظات مكتوبة يجب تدميرها بعد الإستخدام. و الملاحظات الإلكترونية يجب أن تتماشى مع معايير SAFETAG.
...
يساعد هذا المحتوى المدقق تقييم أمان الأجهزة الفردية على الشبكة. يتكون هذا المحتوى من المقابلات والفحوصات والتفتيش على الأجهزة.

### غرض


فالأجهزة المخترقة لديها القدرة على تقويض أي محاولة تنظيمية أخرى لحماية المعلومات. فمعرفة ما إذا كانت الأجهزة تتلقى البرامج الأساسية وترقيات الأمان وما هي الحماية الأساسية ضد الوصول غير المصرح به ضروري لتصميم استراتيجية لجعل المضيف أكثر أمناً.
...
* ** فحص يدوي لأجهزة المقابلة أو التدقيق: ** فحص وتسجيل المعلومات على أجهزة المستخدم سواء الخاصة بالعمل أو الأجهزة الشخصية لإعتبارات آمنية مثل (مستويات التصحيح ، امتيازات المستخدم ، تشفير محرك الأقراص ، تشغيل المنافذ / الخدمات ، قدرات مكافحة الفيروسات)
* **إستطلاع المستخدمين حول كلمات المرور:** أطلب من الموظفين أخذ إستطلاع المستخدمين حول كلمات المرور لكل الأجهزة المستخدمة في العمل. [^password_survey]^,^[^password-security].
* **يوم من أيام الحياة:** أطلب من الموظفين إعلامك "بيوم معتاد في حياتهم" لترى نوعية الأجهزة التي يستخدمونها، كيف يستخدمونها، و ما نوع البيانات التي عليهم التعامل معها لأداء عملهم.
...
### ملخص
هذا المكون يساعد المدقق على إكتشاف عيوب محتملة في أجهزة الشركة وخدماتها وتصميمات التطبيقات والشبكات وذلك عن طريق اختبارها ومقارنتها بمجموعة متنوعة من المواردالمتصلة أو الغير متصلة على الانترنت (ثغرة قواعد البيانات ، تحذيرات البائعين ، وتحقيقات المدقق) لتحديد نقاط الضعف المعروفة. يجب أن يتم تحليل الثغرات الأساسية جنباً إلى جنب مع الأنشطة الأخرى حتى يمكن جمع الأدلة من الشبكة ، ومع ذلك ، يمكن إجراء بحث أكثر عمقًا حول عمليات استكشاف محددة بعد التدقيق في الموقع للاستفادة بشكل كامل من الوقت القصير الذي يمتلكه المراجع.

### غرض

ليس غريبا أن تدير منظمة غير حكومية لحقوق الإنسان وهي تعاني من ضائقة مالية البنية التحتية الحيوية للمعدات المتاحة. قد تقوم منظمة ذات موارد أفضل بحشد خدماتها الحيوية في مركز معلومات بعيد، أو أن تستعين بمصادر خارجية للبنية التحتية لتقنية المعلومات من مزودي الخدمات السحابية مثل Google Apps و / أو الخدمات المخصصة (Dropbox ، و Yahoo! mail ، و Wordpress ، وما إلى ذلك). وبغض النظر عن ذلك، فانه من النادر أن تجد شخص مختص بتحديث واصلاح الانظمة بعد اطلاق الثغرات
...
* ما هو مستوى الإثبات الذي تحتاج إلى تحديده لتوضيح أهمية (أو أهمية) وجود ثغرة للمنظمة؟
* ماالذي قد تراه المنظمة وقسم تقنية المعلومات فيما يخص الوقت المناسبالمطلوب فيه الحصول على المعلومات التي تريدها من فريق قسم تقنية المعلومات؟
...
* ** فحص ملفات تكوين الخدمة: ** فحص ملفات الضبط للثغرات باستخدام ارشادات "التصلب" ، أو "الأخطاء الشائعة" الموجودة على الإنترنت.
...
هذا المكون يمكن مدقق من معرفة بيانات الدقيقة الموجودة لدى المؤسسة، ومكان تخزينها، وكيفية نقلها.

### غرض

غالبًا ما يتم تخزين الملفات الحساسة عبر أجهزة متعددة بمستويات مختلفة من الأمان. يسمح تقييم بيانات مدقق بالتوصية و تأمين حلول تخزين  تحقق على أفضل وجه تحليل الخطر للمنظمة واحتياجات سير العمل. في حين أن مدقق لديه نظرة ثاقبة على بعض من هذا على أساس وصول إلى الشبكة وخريطة عمل الشبكة ، فإن التفاهم بين الموظفين والاتفاق على ما يشكل بيانات حساسة سوف يدعم تغيير التنظيمي في وقت لاحق.
...
* ** نشاط البيانات الخاصة: ** من خلال هذا النشاط قم بإرشاد الموظفين بعمل قائمة موحدة للبيانات الخاصة بالمنظمة [^معلومات_شخصية_للحفاظ_على_الخصوصية]

إذا لم يكن من الممكن إجراء هذه الأنشطة بشكل شخصي ، فيمكنك إجراءها عن بُعد من خلال تطبيق أحد أساليب التيسير عن بُعد الموضحة في التذييل [تيسير عن بعد](#appendix-remote-facilitation) 
...
في حين SAFETAG يركز على أمن البيانات ، لا يمكن تجاهل طبيعة الأجهزة المادية ، محركات الأقراص الاحتياطية ، الخوادم ، وحتى الشبكات السلكية.

بالنسبة للعديد من المنظمات، تعتبر التهديدات الرقمية التي تعتمد على الوصول المادي أقل احتمالًا. لدرجة أن العديد من المختصين في مجال الأمن يقرون أنه لا يوجد دفاع مناسب ضد مهاجم مع وصول مادي إلى الأجهزة الحساسة. في حين أن هنالك بعض الحقيقة فيما ينصحون ، لكن لاتكون هذه النصيحة مفيدة لمنظمات المجتمع المدني التي تعمل في نطاق صغير أو وسائل إعلام مستقلة. إن المخاطر التي تواجهها منظمات المناصرة والمنظمات الإعلامية أكثر تنوعاً ، وقد تؤدي تكلفة المعلومات المفقودة إلى شل قدرتها عن العمل تماماً. كما أن لهذه المخاطر شدة خطر عالي ، على الرغم من على الرغم من احتمالية عالية بنفس القدر لهذه المنظمات.

وبناءا على التهديدات المحددة لكل منظمة ، ينبغي على المدقق أن يضع في اعتباره التحديات ليس فقط لتطهير البيانات مرة واحدة ، ولكن أيضا الطرق المحتملة التي يمكن للخصم استخدامها للوصول الكلي أو الجزئي للمؤسسة أو لأجهزتها وبالتالي اختراقها عن بعد ، أو التسبب بالضرر للمنظمة من خلال التدمير المباشر للبيانات.
...
* ** الوصول المادي إلى الشبكة المحلية و WiFi والسيرفرات: ** قم بجولة في المكتب وابحث عن أجهزة الشبكة والسيرفرات ومقابس الشبكة المكشوفة ، وقم بتوثيق مدى صعوبة زيارة أحد الزائرين أو اقتحام احدهم بعد ساعات العمل للولوج الى الأنظمة الحساسة. حدد مدى الشبكة اللاسلكية ومدى سهولة معرفة أنها متصلة بالمنظمة.
* ** تعيين نقاط الضعف المادي المحتملة مع تأثيرات الأمان الرقمي: ** توثيق نقاط الضعف المحتملة لأمن المعلومات في المنظمة استنادًا إلى الجوانب المادية - على سبيل المثال ، الأجهزة غير المشفرة التي يمكن سرقتها أو كلمات المرور المكتوبة أو حتى البيانات الوصفية للشبكة اللاسلكية.
...
وضع المؤسسة المضيفة في قلب عملية تقييم المخاطر يسمح للمدقق بسرد المخاطر و التوصيات من وجهة نظرهم. و كلما زاد دور الموظفين في العملية، كلما أصبحوا أكثر إستعدادا للتعامل مع المخاطر عند إنتهاء التدقيق. [^social_engineering_important_all] من خلال إشراك أكبر عدد من الموظفين، فإن المدقق يقدم إطارا للموظفين لتفحص مسببات القلق المستقبلية عند رحيله. الأنشطة المسجلة أثناء العملية -سواء رسمية أو غير رسمية- ستسمح بإزالة العوائق المؤسسية و النفسية الإجتماعية أمام تبني أنشطة و ممارسات جديدة.
...
إذا لم يكن من الممكن إجراء هذه الأنشطة بشكل شخصي، فيمكنك إجراءها عن بُعد من خلال تطبيق أحد أساليب التيسير عن بُعد الموضحة في ملحق  [Remote Facilitation](#appendix-remote-facilitation).
...
### غرض
أمر عادي أن يتم العثور على أنشطة أو برامج أو مرور مثير للشبهة أثناء تدقيق SAFETAG. على ممارسي SAFETAG أن ينتبهوا للأنشطة المريبة عند قيامهم بتطبيق طرق و أنشطة SAFETAG الأخرى، بداية من اتعامل مع الموظفين و النقاش معهم وصولا إلى التقييم اليدوي للأجهزة و تحليل المرور في الشبكة.
...
### أساليب المعالجة
** نظراً لضيق الوقت المحدود ، يجب على المدقق التركيز على تحديد الأنشطة المشبوهة والتركيز عليها بسرعة **. العديد من هذه ستكون إيجابيات خاطئة ذات صلة ببرامج أخرى غير ضارة مما يجعل الجهاز "يعمل بشكل غريب" أو أنواع أخرى من البرامج الضارة الأقل خطورة (وغير مستهدِفه) مثل الإعلانات المزعجة أو فيروس الفدية.

عندما يصبح من المستحيل إستبعاد الخطر. فإن جمع الأدلة و بدء بحث و تحليل أساسيين و تقييم المخاطر و تأثيرها سيساعدك على وضع أولوية لإتخاذ إجراءات إضافية. يفضل تأجيل التحليل الثنائي لما بعد التقييم و الإبلاغ و مراحل المتابعة. إذا تم إختراق موارد مهمة فإن على المدقق تنظيم خطط عاجلة لتقليل الأثر مع بقية مختصي الIT.
...
* **تحليل مقدرات الخصوم** يجب أن يكون ذلك من مخرجات أعمال البحث ذات السياق التقني. هل هناك أي تهديدات متطورة و عنيدة يجب وضعها في الحسبان؟ كيف تعمل هذه التهديدات؟ هل هناك أي أثار إختراق يجب الحذر منها؟
* **تحليل الأحداث و النشاطات المحددة المشكوك بها** إن كان للمؤسسة شكوك محددة أو دليل على هجوم موجه، فإن على المدقق التركيز عليهم و مقارنتهم بأي هجمات معروفة أو إجراء مزيد من البحث عليهم.
* **البحث عن أي أثار للإختراق و تصيد التهديدات** إذا كانت المؤسسة تشك في حدوث إختراق لها و لكن ليس بإمكانها تحديد جهاز أو عملية أو بريد إلكتروني معين، فإن المدقق يستغل التقنيات التي تسمح له بالتحقيق في الأمر بشكل ذكي.
...
هذا الجزء يستخدم العديد من الأنشطة لتحديد أنواع المخترقين المحتملة و جمع معلومات عن قدرتهم على تهديد المؤسسة. يشمل ذلك معرفة تاريخ مخترق محدد في القيام بتهديدات معينة و قدرته على تنفيذ هذا التهديد حاليا. بالإضافة لدليل يثبت أن هذا التهديد ينوي تسخير موارد ضد الهدف.
