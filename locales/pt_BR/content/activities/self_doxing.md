...
approaches:
  ...
  - Técnico
authors:
  - Linha de Suporte em Segurança Digital da Access Now
skills_trained: []
remote_options:
  - with-support
...
summary: |
  Doxing (também escrito "doxxing" ou "d0xing, é uma palavra derivada de "documentos" ou "docs") consiste em rastrear e reunir informações sobre alguém usando fontes disponíveis livremente na internet (chamadas OSINT ou Open Source INTelligence).
  O doxing baseia-se na ideia de que "quanto mais você sabe sobre o seu alvo, mais fácil será encontrar suas falhas". Uma pessoa ou organização mal-intencionada (um ator malicioso) pode usar esse método para identificar informações valiosas sobre o seu alvo. Depois de encontrar informações confidenciais, ele pode publicá-las para difamar ou chantagear a pessoa alvo, ou usá-las para outros fins.
  Esta atividade tem como objetivo ajudar os participantes a identificar quaisquer informações pessoais indesejadas que possam estar disponíveis publicamente online e conscientizá-los sobre o risco do doxing e como evitá-lo.
short_summary: Isso ajuda a identificar informações pessoais online e o risco que elas representam ao possibilitar o doxing.
materials_needed: |
  * Computador com conexão à Internet
  * Projetor
  * Impressões deste [guia de auto-doxing
...
considerations: >
  * Recomende o uso do navegador Tor para esta atividade.
...
overview: |
  **Autodoxing:**
  ...
  Esta atividade tem como objetivo mostrar às pessoas da equipe como pesquisar os rastros de dados que deixam online, bem como melhorar os resultados da atividade Reconhecimento Manual com pesquisas realizadas pelos próprios indivíduos, o que ajuda a proteger sua privacidade e torna os resultados mais detalhados. Com essa abordagem, a auditora só será informada sobre os resultados se forem indicadas medidas de mitigação, como remoções.
  * Explique ao grupo que os assediadores e stalkers usam várias ferramentas e técnicas para coletar informações sobre seus alvos.
  * Explique que, durante esta atividade, os participantes usarão as mesmas ferramentas e técnicas em si mesmos, praticando o "autodoxing".
  * Identifique mecanismos de pesquisa relevantes e outros sites para autodoxing no contexto específico da organização.
  * Os participantes praticam o autodoxing em duplas.
  (Alternativamente, esta atividade pode ser atribuída como lição de casa, em vez de praticada como exercício em grupo, para proteger a privacidade dos participantes).
  * Se forem encontrados resultados significativos que possam colocar em risco um indivíduo ou toda a organização, instrua-os sobre como fazer uma solicitação de remoção ao site e/ou mecanismo de busca relevante.
recommendations: >-
  Esta atividade é baseada no Guia de AutoDoxing ( [_Self-Doxing Guide_](https://guides.accessnow.org/self-doxing.html) ) da Access Now, que contém leituras adicionais e recomendações.
  ...
  A seguir, apresentamos uma lista de links para iniciar uma solicitação de remoção:
  ...
  * TikTok: 
    * [Como denunciar um usuário](https://support.tiktok.com/pt_BR/safety-hc/report-a-problem/report-a-user)
    * [Como fazer diversos tipos denúncias](https://www.tiktok.com/safety/pt-br/reporting)
---
