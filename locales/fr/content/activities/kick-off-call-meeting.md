...
summary: "Un appel ou une réunion de lancement est généralement organisé au moment de convenir de mener une évaluation SAFETAG. Considérez ces rencontres comme faisant partie intégrante du processus d'évaluation, car vous y collecterez des informations sur les risques et les aspects techniques, ainsi que des renseignements sur l'historique de l'organisation, sa culture et des considérations logistiques importantes pour l'évaluation, qui orienteront vos prochaines actions dans le cadre de celle-ci. "
