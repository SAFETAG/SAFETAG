---
title: Calendrier et planification de l'audit
approaches:
  - Recherche
position: 50
authors: []
...
summary: Cette section fournit des conseils sur la création d'un calendrier d'audit réaliste pour votre plan d'évaluation.
materials_needed: ""
walk_through: |
...
considerations: ""
skills_required: []
overview: Passez en revue ces notes en préparation de l'audit lorsque vous commencez à établir votre calendrier. Cela fournit un aperçu approximatif et suggéré de la façon de planifier votre temps sur site pour un audit SAFETAG, et quelques rappels du travail que vous devez avoir terminé avant d'arriver dans le pays. Vous pouvez adapter ce plan ou utiliser ses sections comme modèle pour développer votre propre calendrier adapté au contexte de chaque audit.
recommendations: ""
---
