...
walk_through: >
  ...
  3. Categorize the devices that you will discover. This is to make it more efficient later when runing vulnerability scans, enabling you to target them effectively. For devices which are not easily categorized, see the IoT section below 4. **Port/Service research, and How to decide if an open port is suspicious**  If a port is open in a personal computer or mobile device, this should be immediately considered suspicious and investigated.
  ...
  **Servers**
  ...
  | Port         | Service        | | ---- | ------- | | 21           | FTP            | | 22           | SSH            | | 23           | Telnet         | | 25           | SMTP           | | 53           | DNS            | | 80           | HTTP           | | 110          | POP            | | 139          | SMB            | | 143          | IMAP           | | 194          | IRC            | | 443          | HTTPS          | | 465          | SMTP           | | 530          | CUPS           | | 587          | SMTP           | | 667          | IRC            | | 993          | IMAP           | | 995          | POP            | | 1900         | port authority | | 3306         | MySQL          | | 6881 to 6889 | Torrent        | | 6969         | Torrent        | | 8080         | HTTP           |
  ...
  * SNMP * SMB * NetBIOS * Shared Folders * RDP * Telnet * Password Sniffing
  ...
  * Web servers * DNS servers * Mail servers * Gateway devices * FTP Servers * Cloud servers
  ...
  **Working with GUI using Zenmap**
  ...
  | Option                           | Command                                                                                                          | | -------------------------------- | ---------------------------------------------------------------------------------------------------------------- | | **Intense Scan**                 | `nmap -T4 -A -v`                                                                                                 | | **Intense Scan + UDP**           | `nmap -sS -sU -T4 -A -v`                                                                                         | | **Intense Scan + all TCP ports** | `nmap -p 1-65535 -T4 -A -v`                                                                                      | | **Intense Scan - No ping**       | `nmap -T4 -A -v -Pn`                                                                                             | | **Ping Scan**                    | `nmap -sn`                                                                                                       | | **Quick Scan**                   | `nmap -T4 -F`                                                                                                    | | **Quick Scan Plus**              | `nmap -sV -T4 -O -F --version-light`                                                                             | | **Quick Traceroute**             | `nmap -sn --traceroute`                                                                                          | | **Regular Scan**                 | `nmap`                                                                                                           | | **Slow Comprehensive Scan**      | `nmap -sS -sU -T4 -A -v -PE -PP -PS80,443 -PA3389 -PU40125 -PY -g 53 --script ”default or (discovery and safe)”` |
considerations: |
...
overview: >
  * စစ်ဆေးမှု၏ နယ်ပယ်တွင် မည်သည့်စက်ပစ္စည်းနှင့် ဆာဗာများ ရှိနေသည်ကို အတည်ပြုပြီး မည်သည့် ဝန်ဆောင်မှုပေးသူများ (ဝက်ဘ်ဆိုက် အထိုင်အတွက် ဝန်ဆောင်မှု ပေးသူများ၊ cloud အထိုင်အတွက် ဝန်ဆောင်မှု ပေးသူများ စသည်ဖြင့်) ကို အသိပေးပြီး ဖြစ်ကြောင်းနှင့် မည်သည့်စကင်န်ဖတ်ခြင်းဖြင့်မဆို အဆင်ပြေသည်ကို အတည်ပြုပါ။
